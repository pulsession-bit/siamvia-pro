...
export default function SitemapPage() {
    ...
    const mainVisas = [
        ...
        { title: t('nav.elite'), href: langPath('elite-visa'), icon: <ShieldCheck className="w-5 h-5" />, key: 'elite' },
        ...
        { title: t('nav.business'), href: langPath('business-visa'), icon: <FileText className="w-5 h-5" />, key: 'business' },
    ];
