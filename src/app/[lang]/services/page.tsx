...
/**
 * Services Page - Nos Services & Tarifs
 * 
 * Affiche les différents packs de services avec leurs fonctionnalités.
 * Les tarifs sont gérés via le scoring engine externe.
 */
const ServicesPage: React.FC = () => {
    const { t } = useLanguage();

    // Configuration des tiers de service
    const tiers = [
        {
            id: 'audit',
 ...
 * Carte individuelle pour chaque tier de service
 */
