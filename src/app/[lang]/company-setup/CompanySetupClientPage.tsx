...
import { Building2, FileCheck, ShieldAlert, Briefcase, Landmark, CheckCircle2, ArrowRight, AlertTriangle, Scale } from 'lucide-react';
            ...
            <div className="min-h-screen bg-slate-50 py-20">
                <Container>
                    <div className="max-w-3xl mx-auto text-center">
                        <h1 className="text-4xl font-bold text-slate-900 mb-6">Company Registration in Thailand</h1>
                        <p className="text-lg text-slate-600 mb-8">
                            This comprehensive guide is currently available in French. The English version is being prepared for our 2026 update.
                        </p>
                        <p className="text-slate-500 mb-8">
                            If you need assistance setting up a company (Thai Limited, BOI, Amity), please contact our team directly.
                        </p>
                        <Link
                            href={`/${lang}/contact`}
