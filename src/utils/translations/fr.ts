export const fr = {
  ...
  search_page: {
    meta: {
      title: "Comparateur Visas Thaïlande 2026 (DTV, Elite, Touristique)",
      description: "Quel visa choisir pour la Thaïlande ? Notre IA analyse votre profil et compare les visas DTV, Elite, Retraite et Touristique. Simulation gratuite."
    },
    hero: {
