...
import { CheckCircle2, AlertTriangle, Clock, Globe, ShieldAlert, ArrowRight, Plane } from 'lucide-react';
            ...
            <PageContainer maxWidth="max-w-4xl" negativeMargin>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <Card variant="white" className="p-5 text-center">
                                ...
                                <div className="text-sm text-slate-500 uppercase tracking-wider font-semibold">
                                    {t(`${pageKey}.duration_initial_label`)}
                                </div>
                                <div className="text-xl font-bold text-slate-900">
                                    {t(`${pageKey}.duration_initial_value`)}
                                </div>
                            </Card>
                            <Card variant="white" className="p-5 text-center">
                                <Globe className="h-8 w-8 text-blue-500 mx-auto mb-2" />
                                <div className="text-sm text-slate-500 uppercase tracking-wider font-semibold">
                                    {t(`${pageKey}.duration_max_label`)}
                                </div>
                                <div className="text-xl font-bold text-slate-900">
                                    {t(`${pageKey}.duration_max_value`)}
                                </div>
                            </Card>
                        </div>
                    </section>
                            ...
                            <div className="flex items-start mb-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-red-800 mb-1">
                                        {t(`${pageKey}.work_warning_title`)}
                                    </h3>
                                    <p className="text-slate-700">
                                        {t(`${pageKey}.work_warning_text`)}
                                    </p>
                                </div>
                            </div>
                        </Card>
                            ...
                            <div className="flex items-start text-slate-700">
                                ...
                                <div>
                                    <h3 className="font-bold mb-2">
                                        {t(`${pageKey}.limitations_risk_title`)}
                                    </h3>
                                    <p className="text-sm leading-relaxed">
                                        {t(`${pageKey}.limitations_risk_text`)}
                                    </p>
                                </div>
                            </div>
                        </Card>
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card variant="dark" className="p-8 text-center flex flex-col justify-center items-center">
                        <h3 className="text-xl font-bold text-white mb-2">{t(`${pageKey}.cta_help_title`)}</h3>
                        <p className="text-slate-400 mb-6 text-sm">{t(`${pageKey}.cta_help_subtitle`)}</p>
                        <CTAButton href={ctaHelpLink} variant="primary" fullWidth>
                            {t(`${pageKey}.cta_help_btn`)}
                        </CTAButton>
                    </Card>
