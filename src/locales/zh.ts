export const zh = {
  ...
  "services_page": {
    ...
    "hero_title": "我们的服务与价格",
    "hero_subtitle": "完整材料准备 + 大使馆递交",
    "hero_tagline": "我们不是大使馆，我们是您的坚实盟友。",
    "hero_tagline_secondary": "为您在泰国的安心提供全方位的专业支持。",
    "custom_support_title": "需要量身定制的服务吗？",
    "custom_support_desc": "我们的专家可以分析您的具体材料，并为您制定最佳的移居策略。",
    "custom_support_btn": "联系专家",
    "tier_standard": "标准",
    "tier_standard_desc": "完整材料准备 + 大使馆递交",
    "tier_standard_price": "¥2,950 (~14,000 THB)",
    "tier_express": "48小时加急",
    "tier_express_desc": "完整材料准备 + 大使馆加急递交",
    "tier_express_price": "¥4,450 (~21,000 THB)",
    "tier_premium": "尊享",
    "tier_premium_desc": "完整材料准备 + 大使馆递交 + 强化跟踪",
    "tier_premium_price": "¥6,680 (~32,000 THB)",
    "btn_start": "开始您的申请",
    "recommended": "推荐",
    "insurance_title": "需要旅行保险吗？",
    "insurance_desc": "根据签证类型，可能需要10万美元保额的医疗保险。",
    "insurance_link": "查看我们的保险合作伙伴",
    ...
    "admin_fees_visa": "签证费（根据签证类型和递交国家而异）：从35 €起至数百欧元不等",
    "admin_fees_center": "签证中心/服务商/邮寄服务可能产生的费用：视具体情况而定",
    "options_title": "附加服务",
    "option_traduction": "认证翻译",
    "option_traduction_price": "39–89 € / 份",
    "option_legalisation": "公证/海牙认证",
    "option_legalisation_price": "49–129 € / 份（不含官方费用）",
    "option_assurance": "合规旅行保险（推荐对接）",
    "option_assurance_price": "0 €（您直接向保险公司付款）",
    "option_rdv": "预约/递交时段/上门服务",
    "option_rdv_price": "49–149 €",
    "option_suivi": "递交后跟踪与催办",
    "option_suivi_price": "尊享套餐已包含，否则49 €",
  ...
  "insurance_page": {
    ...
    "why_title": "为什么需要旅行保险？",
    "stat_hospital_cost": "¥4,000,000+ (~18,000,000 THB)",
    "stat_hospital_label": "泰国私人诊所住院的潜在费用",
    "stat_recommended": "¥2,400,000 (~11,000,000 THB)",
