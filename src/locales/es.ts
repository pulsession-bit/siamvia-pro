export const es = {
  ...
  "services_page": {
    ...
    "hero_title": "Nuestros Servicios y Tarifas",
    "hero_subtitle": "Expediente completo + presentación en la embajada",
    "hero_tagline": "No somos la embajada, somos sus aliados.",
    ...
    "custom_support_desc": "Nuestros expertos están disponibles para analizar su expediente específico y proponerle la mejor estrategia de expatriación.",
    "custom_support_btn": "Hablar con un experto",
    "tier_standard": "Standard",
    "tier_standard_desc": "Expediente completo + presentación en la embajada",
    "tier_standard_price": "390 € (~14,000 THB)",
    "tier_express": "Express 48h",
    "tier_express_desc": "Expediente completo + presentación urgente en la embajada",
    "tier_express_price": "590 € (~21,000 THB)",
    "tier_premium": "Premium",
    "tier_premium_desc": "Expediente completo + presentación en la embajada + seguimiento reforzado",
    "tier_premium_price": "890 € (~32,000 THB)",
    "btn_start": "Iniciar su solicitud",
    "recommended": "Recomendado",
    "insurance_title": "¿Necesita un seguro de viaje?",
    "insurance_desc": "El seguro médico con cobertura de 100.000 USD puede ser requerido (según el visado).",
    "insurance_link": "Ver nuestros socios de seguros",
    "pack_feat1": "Verificación de elegibilidad + checklist personalizado",
    "pack_feat2": "Preparación/cumplimentación de formularios",
    "pack_feat3": "Revisión y conformidad de documentos (pasaporte, fotos, pruebas financieras…)",
    "pack_feat4": "Montaje final del expediente (versión \"embajada\")",
    "pack_feat5": "Presentación en la embajada/consulado + seguimiento hasta la devolución del pasaporte",
    "admin_fees_title": "Gastos administrativos",
    "admin_fees_subtitle": "Pagados directamente a la embajada/consulado",
    "admin_fees_visa": "Tasas de visado (variable según tipo de visa + país de presentación): desde 35 € hasta varios cientos de €",
    "admin_fees_center": "Posibles gastos de centro de visas / proveedor / servicio de correo: según la oficina",
    ...
    "option_legalisation_price": "49–129 € / documento (sin tasas oficiales)",
    "option_assurance": "Seguro de viaje conforme (puesta en contacto)",
    "option_assurance_price": "0 € (usted paga directamente al asegurador)",
    "option_rdv": "Franja horaria / cita / desplazamiento para presentación",
    "option_rdv_price": "49–149 €",
    "option_suivi": "Seguimiento post-presentación y recordatorios",
    "option_suivi_price": "Incluido en Premium, si no 49 €",
    "included_title": "Lo que incluye cada pack",
    "conditions_title": "Condiciones",
    "condition1": "Las tasas de embajada siempre son adicionales (y no reembolsables).",
    "condition2": "Si la embajada exige la presencia del solicitante: presentación \"asistida\" (le acompañamos) en lugar de presentación \"representada\"."
  },
  "eligibility": {
    "steps": [
      "Perfil",
