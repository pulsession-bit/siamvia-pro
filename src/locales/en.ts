export const en = {
  ...
  "ai_technology_page": {
    "meta": {
      "title": "AI Visa Technology | Scoring, Voice Agent & Audit — Siam Visa Pro",
      "description": "Discover how Siam Visa Pro uses AI to score your eligibility, guide you via voice call (Gemini 2.5), and generate a personalized audit report."
    },
    "hero_badge": "Artificial Intelligence",
    "hero_title": "Your visa, powered by ",
    "hero_highlight": "cutting-edge AI",
    "hero_subtitle": "Siam Visa Pro is the first immigration agency to combine AI scoring, a live voice agent (Google Gemini 2.5), and automated audit reports to maximize your chances of obtaining your Thai visa.",
    "hero_cta": "Start my Free AI Audit",
    "stat1": "Cases analyzed by AI",
    "stat2": "Average acceptance rate",
    "stat3": "Average analysis time",
    "stat4": "AI Agent availability",
    "f1_badge": "Proprietary Scoring Engine",
    "f1_title": "Visa Eligibility Score /100",
    "f1_desc": "Our AI algorithm evaluates your complete profile in seconds. It detects strengths and weaknesses in your application, identifies refusal risks, and proposes corrective actions before embassy submission.",
    "f1_point1": "Multi-criteria analysis: finances, employment, documents, history",
    "f1_point2": "Proactive embassy refusal risk detection",
    "f1_point3": "Personalized recommendations and action plan",
    "f1_point4": "Calibrated on official Thai MFA rules",
    "score_crit1": "Documents",
    "score_crit2": "Finances",
    "score_crit3": "Pro Profile",
    "score_crit4": "Completeness",
    "f2_badge": "AI Voice Agent — Google Gemini 2.5",
    "f2_title": "Talk to an AI Expert in one click",
    "f2_desc": "Our voice agent is powered by Google's Gemini 2.5, the world's most advanced AI model. In one click, start a real-time call with an AI specialist trained on the full scope of Thai immigration law.",
    "f2_point1": "Instant voice call — no queue or chatbot",
    "f2_point2": "Multilingual: English and French in real time",
    "f2_point3": "Available 24/7 — even during holidays",
    "f2_point4": "Secure and confidential connection (no data stored)",
    ...
    "f3_badge": "Complete Audit Report",
    "f3_title": "A clear, personalized Action Plan",
    "f3_desc": "After analysis, our AI generates a detailed report including your score, areas of concern, recommended visa, and a step-by-step action plan. This report is then validated by a human expert.",
    "f3_point1": "Comprehensive exportable PDF report (12+ pages)",
    "f3_point2": "Step-by-step action plan with deadlines",
    "f3_point3": "Visa option comparison with recommendation",
    "f3_point4": "Personalized required documents checklist",
    "report_title": "AI Audit Report",
    "report_step1": "Profile analysis completed",
    "report_step2": "Eligibility score calculated",
    "report_step3": "Recommended visa identified",
    "report_step4": "Expert validation in progress...",
    "how_title": "How does it work?",
    "how_subtitle": "3 steps to get your complete AI analysis",
    "how_step1_title": "Complete the Audit",
    "how_step1_desc": "Answer a few questions about your situation, documents, and visa project. The AI analyzes your profile instantly.",
    "how_step2_title": "Talk to the AI Agent",
    "how_step2_desc": "Ask your questions via live voice call. The Gemini agent guides you and refines the recommendation in real time.",
    "how_step3_title": "Get your Report",
    "how_step3_desc": "Download your complete PDF audit report with score, action plan, and document list. Validated by a human expert.",
    "cta_title": "Ready to test our AI?",
    "cta_desc": "Get your visa eligibility score in 30 seconds. Free, instant, no commitment.",
    "cta_btn": "Start my Free AI Audit",
    "cta_sub": "No payment required — Immediate results"
  },
  "meta": {
