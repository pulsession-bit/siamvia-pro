export const en = {
  ...
  "ai_technology_page": {
    "meta": {
      "title": "Thailand Visa AI Technology | Scoring, Voice Agent & Audit — Siam Visa Pro",
      "description": "Siam Visa Pro combines human expertise and AI to analyze your Thailand visa application (DTV, Tourist, Retirement, LTR, Non-B). Scoring /100, Gemini 2.5 voice agent and complete audit report."
    },
    "hero_badge": "AI Visa Expert for Thailand",
    "hero_title": "Your Thailand visa, analyzed by an",
    "hero_highlight": "expert AI",
    "hero_subtitle": "Siam Visa Pro combines human expertise and artificial intelligence to analyze your Thailand visa application (DTV, Tourist, Retirement, LTR, Non-B) according to the official criteria of Thai embassies and the Ministry of Foreign Affairs.",
    "hero_subtitle2": "Our system evaluates your eligibility, required documents, financial resources, and professional profile to reduce refusal risks.",
    "hero_cta": "Start my Free AI Audit",
    "audit_badge": "AI Eligibility Audit",
    "audit_title": "Thailand Visa AI Eligibility Audit",
    "audit_desc": "Comprehensive analysis of Thailand visa conditions according to the official criteria of embassies and the Ministry of Foreign Affairs.",
    "audit_result": "👉 Result: a reliable score and a personalized action plan.",
    "audit_card_title": "AI Eligibility Audit",
    "audit_check1": "Full analysis of Thailand visa conditions",
    "audit_check2": "Verification of embassy-required documents",
    "audit_check3": "Financial evaluation against official thresholds",
    "audit_check4": "Stay project consistency check",
    "audit_check5": "Proactive detection of refusal causes",
    "f1_badge": "Proprietary Scoring Engine",
    "f1_title": "Thailand Visa Eligibility Score /100",
    "f1_desc": "Our AI algorithm analyzes over 120 criteria from Thai consular procedures. Each weakness is identified before official submission.",
    "f1_point1": "Financial situation and declared income",
    "f1_point2": "Professional / freelance / business background",
    "f1_point3": "Migration history and previous visas",
    "f1_point4": "Document compliance",
    "f1_point5": "Stability of your Thailand project",
    "score_engine_label": "Visa Eligibility Score",
    "score_crit1": "Documents",
    "score_crit2": "Finances",
    "score_crit3": "Pro Profile",
    "score_crit4": "Completeness",
    "score_crit5": "Stay Project",
    "score_footer": "Each weakness is identified before official submission.",
    "f2_badge": "Live AI Expert — Real-Time Visa Advice",
    "f2_title": "Live AI Expert — Real-Time Visa Advice",
    "f2_desc": "Access an AI voice expert trained in Thai immigration law.",
    "f2_point1": "Understand DTV and long-stay requirements",
    "f2_point2": "Verify your eligibility in real-time",
    "f2_point3": "Anticipate consular objections",
    "f2_point4": "Adjust your application before submission",
    "f2_availability": "Service available 24/7, in French and English.",
    "agent_msg1": "Hello! To guide you, what is the purpose of your stay and how long do you plan to stay in Thailand?",
    "agent_msg2": "I'm a freelancer and want to work from Thailand for 6 months.",
    "agent_msg3": "The DTV Visa would be ideal for your profile. It allows you to stay 180 days per entry, with a possible renewal. Would you like me to evaluate your eligibility?",
    "agent_you": "You",
    "agent_active": "Call in progress — 2:34",
    "f3_badge": "Complete Visa Audit Report",
    "f3_title": "Complete Visa Audit Report",
    "f3_desc": "After analysis, you receive a detailed PDF report including your annotated eligibility score, recommended visa based on your profile, personalized list of required documents, timeline of steps, and comparison of legal options. Each report is validated by a human expert.",
    "report_title": "Visa Audit Report",
    "report_pages": "12+ pages",
    "report_item1": "Annotated eligibility score",
    "report_item2": "Recommended visa based on your profile",
    "report_item3": "Personalized list of required documents",
    "report_item4": "Timeline of steps",
    "report_item5": "Comparison of legal options",
    "report_validated": "✅ Each report is validated by a human expert.",
    "how_title": "How the AI Analysis Works",
    "how_subtitle": "3 simple steps to get your complete analysis",
    "how_step1_title": "Complete the Audit",
    "how_step1_desc": "Secure questionnaire about your situation, documents, and objectives.",
    "how_step2_title": "Automatic Analysis",
    "how_step2_desc": "AI processing based on official consular rules.",
    "how_step3_title": "Validation & Report",
    "how_step3_desc": "Expert review and action plan generation.",
    "cta_title": "Test your eligibility for free",
    "cta_desc": "Get your complete analysis in less than 30 seconds.",
    "cta_item1": "Thailand visa score",
    "cta_item2": "Refusal risks",
    "cta_item3": "Missing documents",
    "cta_item4": "Optimal strategy",
    "cta_btn": "Start my Free AI Audit",
    "cta_sub": "No commitment — Immediate results"
  },
  "meta": {
  ...
  "appointment": {
    ...
    "error_email_exists": "An account already exists with this email. Please log in.",
    "error_weak_pass": "Password must be at least 6 characters.",
    "error_pass_uppercase": "Password must contain at least one uppercase letter.",
    "error_pass_requirements": "Password does not meet security requirements (min 6 characters, 1 uppercase).",
    "error_google": "Error during Google login.",
    "create_account_label": "Create an account to track my file",
    "password_label": "Password",
    "password_help": "6 characters minimum, including 1 uppercase",
  ...
  "tourist_visa_page": {
    ...
    "faqs": [
      {
        "q": "Can I convert my tourist visa to another visa locally?",
        "a": "It is possible in some cases (e.g., to a Marriage or Retirement visa), but it depends on the local immigration. Often, it is simpler and faster to reapply outside."
      },
      {
        "q": "Can I extend my visa by 30 days multiple times?",
        "a": "No, the TR tourist visa 30-day extension can only be done once per entry at an Immigration office."
      },
      {
        "q": "What happens if I stay past my visa end date?",
        "a": "You will be on 'Overstay'. The fine is 500 THB per day of overstay, payable at the airport. Significant overstay can lead to a ban from entering the country."
      },
      {
  ...
  "retirement_visa_page": {
    ...
    "faqs": [
      {
        "q": "Does the money (800,000 THB) need to remain frozen all year?",
        "a": "The funds must be present 2 months before the request and 3 months after approval. For the rest of the year, the balance must never fall below 400,000 THB."
      },
      {
        "q": "Can I work with a retirement visa?",
        "a": "No, any form of work (paid or volunteer) is strictly forbidden. If you want to work online, the DTV visa is more suitable."
      },
      {
        "q": "Do I need to leave the country to renew my visa?",
        "a": "No, your retirement visa extension is done every year directly at the Immigration office in Thailand, without a mandatory exit."
      },
      {
        "q": "What is the added value of Siam Visa Pro compared to a solo application?",
        "a": "Applying on your own carries risks of refusal due to an imprecise file. Siam Visa Pro combines human expertise and the power of AI: our artificial intelligence tools analyze your eligibility in real-time to detect your file's weak points, while our experts optimize your portfolio and your documents. You benefit from a double check — technological and human — to guarantee the highest possible approval rate."
  ...
  "cart": {
    ...
    "transfer_success_desc": "Thank you. Your order is pending funds arrival. Please email payment proof to info@siamvisapro.com to activate service."
  },
  "apply_page": {
    "meta": {
  ...
  "schema": {
    "professional_description": "Thailand's leading visa consultancy specializing in DTV, Elite, LTR, Retirement, Business, and all Thai visa types. Professional portfolio preparation, document review, and embassy submission support with 95%+ approval rate. Based in Bangkok, serving clients worldwide in 11 languages.",
    "service_types": [
    ...
    "founder_title": "Thailand Visa Expert & Immigration Consultant",
    "visa_items": [
      { "name": "DTV Visa (Destination Thailand Visa)", "description": "5-year visa for digital nomads & remote workers. Remote work legally allowed. 500K THB savings required. ~€350." },
      { "name": "Thailand Elite Visa (Privilege Card)", "description": "5-20 year premium residency. VIP airport, government concierge. 600K-2M THB. No income requirement." },
      { "name": "LTR Visa (Long-Term Resident)", "description": "10-year visa. Work permit + 17% flat tax. For professionals earning $80K+/year. 50K THB fee." },
      { "name": "Retirement Visa (Non-O)", "description": "1-year renewable for retirees 50+. 800K THB deposit or 65K THB/month income. ~€50/year." },
      { "name": "Business Visa (Non-B) + Work Permit", "description": "1-year visa for Thai employment. Requires Thai employer + work permit. ~€100." },
      { "name": "Tourist Visa (TR)", "description": "60+30 days. For tourism. ~€30. Most Western passports get 60 days visa-free." },
      { "name": "Education Visa (Non-ED)", "description": "1-year for studying Thai, Muay Thai, or university. ~€50 + tuition." },
      { "name": "SMART Visa", "description": "4-year visa for S-Curve industry experts. Work permit included. No 90-day report. Free." },
      { "name": "Family Visa (Non-O Marriage)", "description": "1-year for spouses of Thai nationals. 400K THB. Work permit possible. ~€50/year." },
      { "name": "Medical Visa (Non-MT)", "description": "90 days+ for medical treatment. Up to 4 companions. ~€50." }
    ],
    "faq": [
      { "q": "What is the best visa for living in Thailand in 2026?", "a": "It depends on your profile: (1) Digital nomads/remote workers → DTV visa (5 years, ~€350), (2) High earners ($80K+/yr) → LTR visa (10 years, work permit, 17% tax), (3) Retirees 50+ → Retirement visa (1 year renewable, ~€50), (4) VIP/hassle-free → Elite visa (5-20 years, €15,000+), (5) Thai employer → Business visa + work permit. SiamVisa Pro helps you choose the best option with a free eligibility assessment." },
      { "q": "Can I work remotely in Thailand legally?", "a": "Yes, with the right visa. The DTV (Destination Thailand Visa) explicitly allows remote work for foreign employers since 2024. It grants 5 years, 180 days per entry. The LTR visa also allows work with a digital work permit. Tourist visas and visa exemptions do NOT permit any form of work, including remote work." },
      { "q": "How much money do I need to live in Thailand long-term?", "a": "Financial requirements vary by visa: DTV requires 500,000 THB (~€13,000) in savings. Retirement requires 800,000 THB (~€20,000) in a Thai bank or 65,000 THB/month income. Marriage visa requires 400,000 THB (~€10,000). LTR requires $80,000+/year income. Elite requires a one-time fee of 600,000-2,000,000 THB." },
      { "q": "What does SiamVisa Pro do?", "a": "SiamVisa Pro is a Thailand-based immigration consultancy helping foreigners obtain Thai visas. Services include: free eligibility assessment, professional portfolio preparation (DTV), document review and translation, embassy and immigration submission support, work permit processing, annual visa renewals, and 90-day reporting assistance. We serve clients in 11 languages with a 95%+ approval rate." }
    ]
  },

  "insurance_page": {
    "meta_title": "Thailand Travel Insurance 2026 — Comparison & Complete Guide | SiamVisa Pro",
    "meta_description": "Complete guide to travel insurance for Thailand: compare Heymondo, Chapka, April, SafetyWing. Visa O-A requirements, digital nomads and retirees.",
    "badge": "Insurance Guide",
    "hero_h1": "Thailand Travel Insurance",
    "hero_title": "Protect your stay in Thailand",
    "hero_subtitle": "Complete guide to travel insurance: essential coverage, best providers comparison and requirements by visa type.",
    "hero_tagline": "Repatriation • Medical expenses • Civil liability",
    "why_title": "Why get travel insurance?",
    "stat_hospital_cost": "$530,000+",
    "stat_hospital_label": "Potential cost of hospitalization in a Thai private clinic",
    "stat_recommended": "$320,000",
    "stat_recommended_label": "Minimum recommended medical expense ceiling",
    "stat_repatriation": "Vital",
    "stat_repatriation_label": "Medical repatriation: essential in case of serious accident",
    "mandatory_title": "Visas requiring mandatory insurance",
    "mandatory_intro": "Some Thai visas require insurance as a condition for issuance. Without a compliant certificate, your application will be rejected.",
    "mandatory_badge": "Mandatory",
    "visa_oa_title": "O-A Visa (1-year long stay)",
    "visa_oa_coverage": "Min. coverage 3,000,000 THB (~€85,000) for medical and hospitalization",
    "visa_oa_duration": "Minimum one-year validity, covering the entire visa duration",
    "visa_oa_certificate": "Official 'Foreign Insurance Certificate' form required, signed by insurer",
    "visa_ow_title": "O-W Visa (10 years)",
    "visa_ow_coverage": "Min. coverage ~€11,500 for hospitalization",
    "visa_ow_duration": "Valid for the entire long-stay visa duration",
    "nomad_title": "Best insurance for Digital Nomads",
    "nomad_subtitle": "2026 comparison of insurance options for remote workers and freelancers",
    "safetywing_desc": "Flexible monthly subscription, worldwide coverage. Very popular among nomads for affordable rates.",
    "april_desc": "Recommended for French nationals, comprehensive coverage including direct billing in the US. Long stays and expatriation.",
    "ava_desc": "Professional equipment protection (laptop, smartphone) plus medical expenses and extreme sports.",
    "genki_desc": "International coverage, online subscription even if you're already abroad.",
    "axa_desc": "Reliable global network, quick access to quality care worldwide.",
    "chapka_desc": "Reference for stays over 90 days and world tours. Covers adventure sports with no deductible.",
    "other_options_title": "Other recommended options",
    "heymondo_desc": "Innovative mobile app, 24/7 medical teleconsultation, one-click assistance.",
    "acs_desc": "Most affordable option, ideal for travelers under 40 seeking essential coverage.",
    "criteria_title": "Essential criteria for choosing",
    "criteria_flexibility": "Flexibility",
    "criteria_flexibility_desc": "No commitment, easy modification or cancellation",
    "criteria_repatriation": "Repatriation",
    "criteria_repatriation_desc": "Essential in case of serious accident",
    "criteria_liability": "Civil liability",
    "criteria_liability_desc": "Protection against damage caused to third parties",
    "criteria_ceiling": "High ceiling",
    "criteria_ceiling_desc": "Minimum €150,000, ideally €500,000+",
    "retirement_title": "Insurance for retired expatriates",
    "retirement_subtitle": "Options by age group for seniors wishing to settle in Thailand",
    "table_insurer": "Insurer",
    "table_age_limit": "Max age",
    "table_highlight": "Highlight",
    "no_limit": "No limit",
    "retirement_mondial": "Best value for seniors",
    "retirement_axa": "Reliable solution with no age limit",
    "retirement_heymondo": "Practical mobile app, 24/7 teleconsultation",
    "retirement_april": "Comprehensive health and repatriation coverage",
    "retirement_acs": "Flexible multi-risk, competitive pricing",
    "age_impact_title": "Impact of age on premiums",
    "age_impact_1": "After 60: higher premiums (e.g. €80 for a 30-year-old → €350 for 70, over 30 days)",
    "age_impact_2": "65-75: 30-50% surcharge. Over 75, premiums may double or application refused",
    "age_impact_3": "From 65: some contracts stop covering death benefit or loss of autonomy",
    "card_title": "Credit card insurance limitations",
    "card_duration_title": "Limited duration",
    "card_duration_desc": "Coverage limited to the first 90 days of stay only.",
    "card_ceiling_title": "Insufficient ceilings",
    "card_ceiling_desc": "Between €30,000 and €155,000 — insufficient for major hospitalization in Thailand.",
    "card_advance_title": "Upfront payment",
    "card_advance_desc": "You must pay all medical costs upfront before seeking reimbursement.",
    "card_conditions_title": "Strict conditions",
    "card_conditions_desc": "Must pay transport with the card. Only covers cardholder and close family.",
    "card_exclusions_title": "Many exclusions",
    "card_exclusions_desc": "Tropical diseases (dengue), scooter accidents, adventure sports, high deductibles.",
    "card_conclusion": "Credit card insurance is insufficient for stays over 3 months or outside Europe.",
    "faq_title": "Frequently asked questions about travel insurance",
    "faqs": [
      { "q": "Which Thai visas require mandatory insurance?", "a": "The O-A visa (1-year long stay) requires insurance covering at least 3,000,000 THB (~€85,000) for medical expenses, with an official 'Foreign Insurance Certificate' signed by the insurer. The O-W visa (10 years) also requires minimum coverage (~€11,500 hospitalization). For other visas (tourist, DTV, Elite), insurance is not mandatory but strongly recommended." },
      { "q": "What are the limits of credit card insurance in Thailand?", "a": "Credit card insurance (Visa Premier, Mastercard Gold) is limited to 90 days, with often insufficient ceilings (€30,000 to €155,000). It requires upfront payment, excludes tropical diseases, motorcycle accidents and adventure sports, and has high deductibles." },
      { "q": "How to choose between Heymondo, Chapka and April?", "a": "Heymondo excels with its mobile app and 24/7 teleconsultation. Chapka (Cap Aventure) is the reference for stays over 90 days and can provide the Foreign Insurance Certificate for O-A visa. April International suits French nationals with US direct billing and expatriation coverage." },
      { "q": "What is the best insurance for a digital nomad in Thailand?", "a": "SafetyWing is the most popular with its flexible monthly subscription. April International suits French nationals. Ava Diginomad stands out for professional equipment coverage. Key criteria: flexibility (no commitment), repatriation, civil liability, and a medical ceiling of at least €150,000 (ideally €500,000+)." }
    ],
    "cta_title": "Need insurance",
    "cta_highlight": "advice?",
    "cta_desc": "Our experts help you choose the right insurance for your visa and profile.",
  ...
  "services_page": {
    ...
    "meta": {
        ...
        "description": "Full document preparation + embassy submission. Standard (390 €), Express (590 €) and Premium (890 €) packages. Thailand visa assistance."
    },
    "hero_title": "Choose the level of support adapted to your case",
    "hero_subtitle": "From complete preparation to reinforced support, we secure every step of your visa application.",
    "hero_tagline": "",
    "hero_tagline_secondary": "",
    "custom_support_title": "Need custom support?",
    "custom_support_desc": "Our experts are available to analyze your specific case and propose the best expatriation strategy.",
    "custom_support_btn": "Talk to an expert",

    "tier_standard": "Standard",
    "tier_standard_price": "390 €",
    "tier_standard_desc": "The essentials for submitting a clean, complete, and compliant application.",
    "tier_standard_ideal": "Ideal for: self-sufficient clients who want to avoid errors",
    "standard_feat1": "Eligibility verification",
    "standard_feat2": "Personalized checklist",
    "standard_feat3": "Form preparation / completion",
    "standard_feat4": "Support documents review",
    "standard_feat5": "Application compliance check",
    "standard_feat6": "Final assembly ready for submission",

    "tier_express": "Express 48h",
    "tier_express_price": "590 €",
    "tier_express_desc": "The best balance between speed, comfort, and security.",
    "tier_express_ideal": "Ideal for: clients who want to save time",
    "express_includes": "Everything in Standard pack",
    "express_feat1": "Priority processing",
    "express_feat2": "Embassy / Consulate submission handling",
    "express_feat3": "Application tracking until passport return",
    "express_feat4": "Prioritized communication",

    "tier_premium": "Premium",
    "tier_premium_price": "890 €",
    "tier_premium_desc": "Reinforced support for demanding cases or clients who want maximum care.",
    "tier_premium_ideal": "Ideal for: sensitive, urgent, or high-stakes applications",
    "premium_includes": "Everything in Express pack",
    "premium_feat1": "Dedicated expert",
    "premium_feat2": "Priority support",
    "premium_feat3": "Reinforced verification of sensitive pieces",
    "premium_feat4": "In-depth control of financial proof",
    "premium_feat5": "Final premium review before submission",
    "premium_feat6": "Reinforced assistance on key journey steps",

    "recommended": "Most popular",
    "btn_start": "Start my application",

    "reassurance_title": "Why our clients choose Siam Visa Pro?",
    "reassurance1": "Human verification of the application",
    "reassurance2": "Reduction of error or omission risks",
    "reassurance3": "Structured support until the final phase",
    "reassurance4": "Clear, fast and personalized process",
    ...
    "admin_fees_visa": "Visa fees (varies by visa type + submission country)",
    "admin_fees_center": "Potential visa center / courier fees",

    "options_title": "Complementary Options",
    "option_traduction": "Certified translations",
    "option_traduction_price": "39–89 € / document",
    "option_legalisation": "Legalization / apostille",
    "option_legalisation_price": "49–129 € / document",
    "option_assurance": "Compliant travel insurance",
    "option_assurance_price": "0 €",
    "option_rdv": "Appointment / submission trip",
    "option_rdv_price": "49–149 €",
    "option_suivi": "Post-submission tracking",
    "option_suivi_price": "Included in Premium, otherwise 49 €",

    "included_title": "Included in each pack",
    "conditions_title": "Conditions",
    "condition1": "Embassy fees are non-refundable.",
    "condition2": "On-site assistance for embassies requiring personal appointment."
  }
};
