export const fr = {
  ...
  "ltr_page": {
    ...
    "faq": [
      {
        "q": "Quelle différence avec le Visa Elite ?",
        "a": "Le Visa Elite est payant et ne permet pas de travailler. Le LTR est 'gratuit' (frais réduits) si éligible et inclut le permis de travail."
      },
      {
        "q": "Puis-je travailler avec un visa LTR ?",
        "a": "Oui, c'est l'un des rares visas incluant un permis de travail numérique (Digital Work Permit) sans quota d'employés thaïs."
      },
      {
        "q": "Revenus minimums requis ?",
        "a": "80,000 USD/an (2 ans) ou mix investissement. Retraités éligibles à 40,000 USD sous conditions d'investissement."
      },
      {
        "q": "Délais d'obtention ?",
        "a": "1 à 3 mois pour l'approbation BOI, puis quelques semaines pour l'émission."
      }
    ],
    "high_value": {
  ...
  "ai_technology_page": {
    "meta": {
      ...
      "description": "Siam Visa Pro combine expertise humaine et IA pour analyser votre dossier de visa Thaïlande (DTV, Touriste, Retraite, LTR, Non-B). Scoring /100, agent vocal Gemini 2.5 et rapport d'audit complet."
    },
    "hero_badge": "IA Experte en Visas Thaïlande",
    "hero_title": "Votre visa thaïlandais, analysé par une",
    "hero_highlight": "IA experte",
    "hero_subtitle": "Siam Visa Pro combine expertise humaine et intelligence artificielle pour analyser votre dossier de visa Thaïlande (DTV, Touriste, Retraite, LTR, Non-B) selon les critères officiels des ambassades et du Ministère des Affaires Étrangères thaïlandais.",
    "hero_subtitle2": "Notre système évalue votre éligibilité, vos documents requis, vos ressources financières et votre profil professionnel afin de réduire les risques de refus.",
    "hero_cta": "Démarrer mon Audit IA Gratuit",
    "audit_badge": "Audit IA d'Éligibilité",
    "audit_title": "Audit IA d'Éligibilité Visa Thaïlande",
    "audit_desc": "Analyse complète des conditions de visa thaïlandais selon les critères officiels des ambassades et du Ministère des Affaires Étrangères.",
    "audit_result": "👉 Résultat : un score fiable et un plan d'action personnalisé.",
    "audit_card_title": "Audit d'Éligibilité IA",
    "audit_check1": "Analyse complète des conditions de visa thaïlandais",
    "audit_check2": "Vérification des documents exigés par l'ambassade",
    "audit_check3": "Évaluation financière selon les seuils officiels",
    "audit_check4": "Contrôle de cohérence du projet de séjour",
    "audit_check5": "Détection proactive des causes de refus",
    "f1_badge": "Moteur de Scoring Propriétaire",
    "f1_title": "Score d'Éligibilité Visa Thaïlande /100",
    "f1_desc": "Notre algorithme IA analyse plus de 120 critères issus des procédures consulaires thaïlandaises. Chaque point faible est identifié avant dépôt officiel.",
    "f1_point1": "Situation financière et revenus déclarés",
    "f1_point2": "Dossier professionnel / freelance / entreprise",
    "f1_point3": "Historique migratoire et visas précédents",
    "f1_point4": "Conformité documentaire",
    "f1_point5": "Stabilité du projet en Thaïlande",
    "score_engine_label": "Score d'Éligibilité Visa",
    "score_crit1": "Documents",
    "score_crit2": "Finances",
    "score_crit3": "Profil Pro",
    "score_crit4": "Complétude",
    "score_crit5": "Projet séjour",
    "score_footer": "Chaque point faible est identifié avant dépôt officiel.",
    "f2_badge": "Expert IA Live — Conseil Visa en Temps Réel",
    "f2_title": "Expert IA Live — Conseil Visa en Temps Réel",
    "f2_desc": "Accédez à un expert IA vocal formé au droit de l'immigration thaïlandaise.",
    "f2_point1": "Comprendre les exigences DTV et long séjour",
    "f2_point2": "Vérifier votre éligibilité en direct",
    "f2_point3": "Anticiper les objections consulaires",
    "f2_point4": "Ajuster votre dossier avant dépôt",
    "f2_availability": "Service disponible 24/7, en français et en anglais.",
    "agent_msg1": "Bonjour ! Pour vous orienter, quel est le motif de votre séjour et combien de temps prévoyez-vous de rester en Thaïlande ?",
    "agent_msg2": "Je suis freelance et je veux travailler depuis la Thaïlande pendant 6 mois.",
    "agent_msg3": "Parfait ! Le Visa DTV serait idéal pour votre profil. Il vous permet de rester 180 jours par entrée, avec un renouvellement possible. Voulez-vous que j'évalue votre éligibilité ?",
    "agent_you": "Vous",
    "agent_active": "Appel en cours — 2:34",
    "f3_badge": "Rapport d'Audit Visa Complet",
    "f3_title": "Rapport d'Audit Visa Complet",
    "f3_desc": "Après analyse, vous recevez un rapport PDF détaillé comprenant votre score d'éligibilité commenté, le visa recommandé selon votre profil, la liste personnalisée des documents requis, le calendrier de démarches et la comparaison des options légales. Chaque rapport est validé par un expert humain.",
    "report_title": "Rapport d'Audit Visa",
    "report_pages": "12+ pages",
    "report_item1": "Score d'éligibilité commenté",
    "report_item2": "Visa recommandé selon votre profil",
    "report_item3": "Liste personnalisée des documents requis",
    "report_item4": "Calendrier de démarches",
    "report_item5": "Comparaison des options légales",
    "report_validated": "✅ Chaque rapport est validé par un expert humain.",
    "how_title": "Comment fonctionne l'analyse IA",
    "how_subtitle": "3 étapes simples pour obtenir votre analyse complète",
    "how_step1_title": "Remplissez l'audit",
    "how_step1_desc": "Questionnaire sécurisé sur votre situation, vos documents et vos objectifs.",
    "how_step2_title": "Analyse automatique",
    "how_step2_desc": "Traitement IA selon les règles consulaires officielles.",
    "how_step3_title": "Validation & rapport",
    "how_step3_desc": "Relecture experte et génération du plan d'action.",
    "cta_title": "Testez gratuitement votre éligibilité",
    "cta_desc": "Obtenez en moins de 30 secondes votre analyse complète.",
    "cta_item1": "Score visa Thaïlande",
    "cta_item2": "Risques de refus",
    "cta_item3": "Documents manquants",
    "cta_item4": "Stratégie optimale",
  ...
  "tourist_visa_page": {
    ...
    "cta_help_btn": "Démarrer votre Audit",
  ...
  "elite_page": {
    ...
    "faqs": [
      {
        "q": "Puis-je entrer et sortir plusieurs fois avec mon visa Elite ?",
        "a": "Oui, c'est un visa à entrées multiples (Multiple-Entry) illimitées pendant toute la durée de votre adhésion (5 à 20 ans)."
      },
      {
        "q": "Dois-je payer des impôts en Thaïlande avec ce visa ?",
        "a": "Le Visa Elite ne vous rend pas automatiquement résident fiscal. Vous ne payez d'impôts que si vous séjournez plus de 180 jours par an ET rapatriez des revenus étrangers en Thaïlande la même année."
      },
      {
        "q": "Ma famille peut-elle m'accompagner ?",
        "a": "Oui, il existe des formules 'Famille' permettant d'inclure les membres directs à tarif réduit."
      },
      {
        "q": "Puis-je travailler avec un Visa Elite ?",
        "a": "Techniquement non, c'est un visa touriste. Cependant, vous pouvez être actionnaire d'une société, ou travailler légalement si vous obtenez un permis de travail (possible avec le Visa Elite combiné à une offre d'emploi)."
      }
    ],
  ...
  "services_page": {
    ...
    "hero_title": "Choisissez le niveau d'accompagnement adapté à votre dossier",
    "hero_subtitle": "De la préparation complète à l'accompagnement renforcé, nous sécurisons chaque étape de votre demande de visa.",
    "hero_tagline": "",
    ...
    "tier_standard_desc": "L'essentiel pour déposer un dossier propre, complet et conforme.",
    "tier_standard_ideal": "Idéal pour : les clients autonomes qui veulent éviter les erreurs",
    "standard_feat1": "Vérification d'éligibilité",
    "standard_feat2": "Check-list personnalisée",
    "standard_feat3": "Préparation / complétion des formulaires",
    "standard_feat4": "Relecture des pièces justificatives",
    "standard_feat5": "Vérification de conformité du dossier",
    "standard_feat6": "Montage final prêt à déposer",

    "tier_express": "Express",
    "tier_express_price": "590 €",
    "tier_express_desc": "Le meilleur équilibre entre rapidité, confort et sécurité.",
    "tier_express_ideal": "Idéal pour : les clients qui veulent gagner du temps",
    "express_includes": "Tout le pack Standard",
    "express_feat1": "Traitement prioritaire",
    "express_feat2": "Prise en charge du dépôt ambassade / consulat",
    "express_feat3": "Suivi du dossier jusqu'au retour du passeport",
    "express_feat4": "Priorisation des échanges liés au dossier",

    "tier_premium": "Premium",
    "tier_premium_price": "890 €",
    "tier_premium_desc": "L'accompagnement renforcé pour les dossiers exigeants ou les clients qui veulent une prise en charge maximale.",
    "tier_premium_ideal": "Idéal pour : les dossiers sensibles, urgents ou à fort enjeu",
    "premium_includes": "Tout le pack Express",
    "premium_feat1": "Expert dédié",
    "premium_feat2": "Support prioritaire",
    "premium_feat3": "Vérification renforcée des pièces sensibles",
    "premium_feat4": "Contrôle approfondi des justificatifs financiers",
    "premium_feat5": "Relecture finale premium avant dépôt",
    "premium_feat6": "Assistance renforcée sur les étapes clés du parcours",

    "recommended": "Le plus choisi",
    "btn_start": "Démarrer ma demande",

    "reassurance_title": "Pourquoi nos clients choisissent Siam Visa Pro ?",
    "reassurance1": "Vérification humaine du dossier",
    "reassurance2": "Réduction du risque d'erreur ou d'oubli",
    "reassurance3": "Accompagnement structuré jusqu'à la phase finale",
    "reassurance4": "Process clair, rapide et personnalisé",
    ...
    "admin_fees_title": "Frais administratifs",
    "admin_fees_subtitle": "Payés directement à l'ambassade/consulat",
    "admin_fees_visa": "Frais de visa (variable selon type de visa + pays de dépôt) : à partir de 35 € jusqu'à plusieurs centaines d'€",
    "admin_fees_center": "Frais éventuels de centre visa / prestataire / service courrier : selon le poste",

    "options_title": "Options complémentaires",
    "option_traduction": "Traductions certifiées",
    "option_traduction_price": "39–89 € / document",
    "option_legalisation": "Légalisation / apostille",
    "option_legalisation_price": "49–129 € / document (hors frais officiels)",
    "option_assurance": "Assurance voyage conforme (mise en relation)",
    "option_assurance_price": "0 € (vous payez l'assureur directement)",
    "option_rdv": "Créneau / RDV / déplacement dépôt",
    "option_rdv_price": "49–149 €",
    "option_suivi": "Suivi post-dépôt & relances",
    "option_suivi_price": "Inclus Premium, sinon 49 €",

    "conditions_title": "Conditions",
    "condition1": "Frais ambassade toujours en sus (et non remboursables).",
    "condition2": "Si l'ambassade exige la présence du demandeur : dépôt « assisté » (nous vous accompagnons) au lieu de dépôt « représenté »."
  },
  "business_visa_page": {
  ...
  "smart_visa_page": {
    ...
    "limitations_risk_title": "Dépendance au BOI",
    "limitations_risk_text": "Votre visa dépend du maintien de votre statut auprès du BOI. Si vous perdez votre emploi ou si l'entreprise perd sa certification, votre visa peut être révoqué.",
    ...
    "cta_help_title": "Besoin d'aide pour ce visa ?",
    "cta_help_subtitle": "Nous accompagnons les entreprises et employés dans le processus BOI.",
    "cta_help_btn": "Démarrer votre Audit",
  ...
  "appointment": {
    ...
    "error_service": "Le service de réservation est temporairement indisponible.",
    "error_generic": "Une erreur est survenue.",
    "error_email_exists": "Un compte existe déjà avec cet email. Veuillez vous connecter.",
  ...
  "about_page": {
    "meta": {
      ...
      "description": "Découvrez l'histoire de Siam Visa Pro, notre équipe d'experts à Bangkok, et notre mission pour simplifier votre expatriation en Thaïlande."
    },
    ...
    "team_title": "L'Équipe",
    "team_description": "Nos experts sont basés à Bangkok, ce qui nous donne une perspective unique sur les exigences consulaires et les réalités de l'immigration locale.",
  ...
  "retirement_visa_page": {
    ...
    "faqs": [
      {
        "q": "L'argent (800 000 THB) doit-il rester bloqué toute l'année ?",
        "a": "Les fonds doivent être présents 2 mois avant la demande et 3 mois après l'obtention. Le reste de l'année, le solde ne doit jamais descendre sous les 400 000 THB."
      },
      {
        "q": "Puis-je travailler avec un visa retraite ?",
        "a": "Non, toute forme de travail (rémunéré ou bénévole) est strictement interdite. Si vous souhaitez travailler en ligne, le visa DTV est plus adapté."
      },
      {
        "q": "Dois-je sortir du pays pour renouveler mon visa ?",
        "a": "Non, l'extension de votre visa retraite se fait chaque année directement auprès du bureau de l'Immigration en Thaïlande, sans obligation de sortie."
      },
      {
