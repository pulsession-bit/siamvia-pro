export const fr = {
  ...
  "services_page": {
    "meta": {
      ...
      "description": "Dossier complet + dépôt à l'ambassade. Packs Standard (390 €), Express 48h (590 €) et Premium (890 €). Accompagnement visa Thaïlande."
    },
    "hero_title": "Nos Services & Tarifs",
    "hero_subtitle": "Dossier complet + dépôt à l'ambassade",
    ...
    "tier_standard_desc": "Dossier complet + dépôt ambassade",
    "tier_standard_price": "390 € (~14,000 THB)",
    "tier_express": "Express 48h",
    "tier_express_desc": "Dossier complet + dépôt ambassade en urgence",
    "tier_express_price": "590 € (~21,000 THB)",
    "tier_premium": "Premium",
    "tier_premium_desc": "Dossier complet + dépôt ambassade + suivi renforcé",
    "tier_premium_price": "890 € (~32,000 THB)",
    "btn_start": "Démarrer votre demande",
    ...
    "pack_feat1": "Vérification d'éligibilité + check-list personnalisée",
    "pack_feat2": "Préparation/complétion des formulaires",
    "pack_feat3": "Relecture & conformité des pièces (passeport, photos, preuves financières…)",
    "pack_feat4": "Montage final du dossier (version « ambassade »)",
    "pack_feat5": "Dépôt à l'ambassade/consulat + suivi jusqu'au retour du passeport",
    ...
    "included_title": "Ce qui est inclus dans chaque pack",
