export const fr = {
  ...
  "ai_technology_page": {
    "meta": {
      "title": "Technologie IA Visa | Scoring, Agent Vocal & Audit — Siam Visa Pro",
      "description": "Découvrez comment Siam Visa Pro utilise l'IA pour scorer votre éligibilité, vous guider par appel vocal (Gemini 2.5) et générer un rapport d'audit personnalisé."
    },
    "hero_badge": "Intelligence Artificielle",
    "hero_title": "Votre visa, propulsé par l'",
    "hero_highlight": "IA de pointe",
    "hero_subtitle": "Siam Visa Pro est la première agence d'immigration à combiner scoring IA, agent vocal live (Gemini 2.5 de Google) et rapport d'audit automatisé pour maximiser vos chances d'obtenir votre visa thaïlandais.",
    "hero_cta": "Lancer mon Audit IA Gratuit",
    "stat1": "Dossiers analysés par l'IA",
    "stat2": "Taux d'acceptation moyen",
    "stat3": "Temps d'analyse moyen",
    "stat4": "Disponibilité de l'Agent IA",
    "f1_badge": "Moteur de Scoring Propriétaire",
    "f1_title": "Score d'Éligibilité Visa /100",
    "f1_desc": "Notre algorithme IA évalue votre profil complet en quelques secondes. Il détecte les forces et faiblesses de votre dossier, identifie les risques de refus et propose des actions correctives avant soumission à l'ambassade.",
    "f1_point1": "Analyse multi-critères : finances, emploi, documents, historique",
    "f1_point2": "Détection proactive des risques de refus d'ambassade",
    "f1_point3": "Recommandations personnalisées et plan d'action",
    "f1_point4": "Calibré sur les règles officielles du MFA thaïlandais",
    "score_crit1": "Documents",
    "score_crit2": "Finances",
    "score_crit3": "Profil Pro",
    "score_crit4": "Complétude",
    "f2_badge": "Agent Vocal IA — Google Gemini 2.5",
    "f2_title": "Parlez à un Expert IA en un clic",
    "f2_desc": "Notre agent vocal est propulsé par Gemini 2.5 de Google, le modèle d'IA le plus avancé au monde. En un clic, lancez un appel en temps réel avec un spécialiste IA formé sur l'ensemble du droit de l'immigration thaïlandaise.",
    "f2_point1": "Appel vocal instantané — pas de file d'attente ni de chatbot",
    "f2_point2": "Multilingue : français et anglais en temps réel",
    "f2_point3": "Disponible 24h/24, 7j/7 — même pendant les jours fériés",
    "f2_point4": "Connexion sécurisée et confidentielle (données non stockées)",
    ...
    "f3_badge": "Rapport d'Audit Complet",
    "f3_title": "Un Plan d'Action clair et personnalisé",
    "f3_desc": "À la fin de l'analyse, notre IA génère un rapport détaillé incluant votre score, les points d'attention, le visa recommandé et un plan d'action étape par étape. Ce rapport est ensuite validé par un expert humain.",
    "f3_point1": "Rapport PDF complet exportable (12+ pages)",
    "f3_point2": "Plan d'action étape par étape avec deadlines",
    "f3_point3": "Comparaison des options de visa avec recommandation",
    "f3_point4": "Liste de documents requis personnalisée",
    "report_title": "Rapport d'Audit IA",
    "report_step1": "Analyse du profil complétée",
    "report_step2": "Score d'éligibilité calculé",
    "report_step3": "Visa recommandé identifié",
    "report_step4": "Validation expert en cours...",
    "how_title": "Comment ça marche ?",
    "how_subtitle": "3 étapes pour obtenir votre analyse IA complète",
    "how_step1_title": "Remplissez l'Audit",
    "how_step1_desc": "Répondez à quelques questions sur votre situation, vos documents et votre projet de visa. L'IA analyse votre profil instantanément.",
    "how_step2_title": "Parlez à l'Agent IA",
    "how_step2_desc": "Posez vos questions en appel vocal live. L'agent Gemini vous guide et affine la recommandation en temps réel.",
    "how_step3_title": "Recevez votre Rapport",
    "how_step3_desc": "Téléchargez votre rapport d'audit PDF complet avec score, plan d'action et liste de documents. Validé par un expert humain.",
    "cta_title": "Prêt à tester notre IA ?",
    "cta_desc": "Obtenez votre score d'éligibilité visa en 30 secondes. Gratuit, instantané, sans engagement.",
    "cta_btn": "Démarrer mon Audit IA Gratuit",
    "cta_sub": "Aucun paiement requis — Résultats immédiats"
  },
  "meta": {
