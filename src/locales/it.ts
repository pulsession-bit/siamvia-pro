export const it = {
  ...
  "services_page": {
    ...
    "hero_title": "I Nostri Servizi & Tariffe",
    "hero_subtitle": "Pratica completa + deposito in ambasciata",
    "hero_tagline": "Non siamo l'ambasciata, siamo i tuoi alleati.",
    "hero_tagline_secondary": "Un'esperienza completa per la tua tranquillità in Thailandia.",
    "custom_support_title": "Hai bisogno di un supporto su misura?",
    "custom_support_desc": "I nostri esperti sono disponibili per analizzare la tua pratica specifica e proporti la migliore strategia di espatrio.",
    "custom_support_btn": "Parla con un esperto",
    "tier_standard": "Standard",
    "tier_standard_desc": "Pratica completa + deposito in ambasciata",
    "tier_standard_price": "390 € (~14,000 THB)",
    "tier_express": "Express 48h",
    "tier_express_desc": "Pratica completa + deposito urgente in ambasciata",
    "tier_express_price": "590 € (~21,000 THB)",
    "tier_premium": "Premium",
    "tier_premium_desc": "Pratica completa + deposito in ambasciata + seguimento rafforzato",
    "tier_premium_price": "890 € (~32,000 THB)",
    "btn_start": "Avvia la tua richiesta",
    "recommended": "Raccomandato",
    "insurance_title": "Hai bisogno di un'assicurazione viaggio?",
    ...
    "pack_feat1": "Verifica dell'idoneità + check-list personalizzata",
    "pack_feat2": "Preparazione/completamento dei moduli",
    "pack_feat3": "Revisione & conformità dei documenti (passaporto, foto, prove finanziarie…)",
    "pack_feat4": "Assemblaggio finale della pratica (versione «ambasciata»)",
    "pack_feat5": "Deposito in ambasciata/consolato + seguito fino alla restituzione del passaporto",
    "admin_fees_title": "Spese amministrative",
    "admin_fees_subtitle": "Pagate direttamente all'ambasciata/consolato",
    "admin_fees_visa": "Spese visto (variabili a seconda del tipo di visto + paese di deposito): a partire da 35 € fino a diverse centinaia di €",
    "admin_fees_center": "Eventuali spese del centro visti / fornitore / servizio postale: secondo la sede",
    "options_title": "Opzioni complementari",
    "option_traduction": "Traduzioni certificate",
    ...
    "option_assurance": "Assicurazione viaggio conforme (messa in contatto)",
    "option_assurance_price": "0 € (paghi direttamente l'assicuratore)",
    "option_rdv": "Fascia oraria / appuntamento / trasferta deposito",
    "option_rdv_price": "49–149 €",
    "option_suivi": "Seguito post-deposito & solleciti",
    ...
    "condition1": "Le spese di ambasciata sono sempre a parte (e non rimborsabili).",
    "condition2": "Se l'ambasciata richiede la presenza del richiedente: deposito «assistito» (ti accompagniamo) invece del deposito «rappresentato»."
  },
  "eligibility": {
    "steps": [
      "Profilo",
