export const ar = {
  ...
  "smart_visa_page": {
    ...
    "definition_content": "تأشيرة SMART هي تأشيرة خاصة تهدف إلى جذب المواهب المؤهلة تأهيلاً عالياً والمستثمرين والمديرين التنفيذيين والشركات الناشئة في القطاعات المستهدفة.",
    "audience_title": "لمن تصلح هذه التأشيرة؟",
    "audience_compatible": "الفئات المناسبة",
    "audience_compatible_list": [
    ...
    "work_no_permit_text": "تأشيرة SMART تغني عن تصريح العمل. لا حاجة لتقديم طلب منفصل لـ Work Permit.",
    "renewal_title": "التمديد",
    "renewal_text": "التأشيرة قابلة للتجديد كل 4 سنوات. الميزة الرئيسية هي أن التقرير لدائرة الهجرة يتم مرة واحدة في السنة.",
    "limitations_title": "القيود ونقاط الحذر",
    "limitations_complex_title": "عملية معقدة",
    "limitations_complex_text": "يتطلب الحصول عليها تحقُّقاً تقنياً من BOI. قد تستغرق العملية برمتها من شهر إلى شهرين.",
