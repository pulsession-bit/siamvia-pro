  ...
  "search_page": {
    ...
    "comparator_guide": {
      ...
      "table": {
        ...
        "rows": [
          ["ビザ免除", "短期滞在", "❌ 不可", "数回（制限あり）", "短期観光"],
          ["観光ビザ (TR)", "中期滞在", "❌ 不可", "シングル", "長期観光"],
          ["DTV ビザ", "長期滞在", "✅ リモートワーク", "マルチプル", "デジタルノマド"],
          ["LTR / リタイアメント", "長期滞在", "❌ (例外あり)", "マルチプル", "退職者 / 居住者"],
          ["エリートビザ", "超長期滞在", "❌ 不可", "マルチプル", "VIP居住者"],
          ["ビジネスビザ (Non-B)", "不定", "✅ 可能", "不定", "就労 / 経営"],
          ["学生ビザ (ED)", "不定", "❌ 不可", "不定", "留学 / 研修"]
        ]
      },
      "sections": [
        {
